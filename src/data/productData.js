...
export const INDEX_ITEMS = [
  { n: "01", title: "Products", desc: "Organize product information in one place." },
  { n: "02", title: "Stock", desc: "See inventory and stock information clearly." },
  { n: "03", title: "Purchases", desc: "Manage purchase activity." },
  { n: "04", title: "Sales", desc: "Manage sales activity." },
  { n: "05", title: "Suppliers", desc: "Keep supplier details organized." },
  { n: "06", title: "Reports", desc: "Support decisions with organized information." },
];

export const HOW_IT_WORKS = [
  { n: "01", title: "Add Products", desc: "Add and organize products in one place." },
  { n: "02", title: "Manage Inventory", desc: "Manage inventory-related activity and stock information." },
  { n: "03", title: "Monitor Operations", desc: "Get a clearer view of day-to-day inventory operations." },
  { n: "04", title: "Make Better Decisions", desc: "Use organized inventory information and reports to support business decisions." },
];
...
export const NAV_LINKS = [
  ...
  { href: "#why", label: "Why InventoryOpz" },
  { href: "#how-it-works", label: "How It Works" },
  { href: "#clients", label: "Live Clients" },
  { href: "#pricing", label: "Pricing" },
];

export const SECTION_IDS = ["tour", "why", "how-it-works", "clients", "pricing"];
